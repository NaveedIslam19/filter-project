...
function getAllProducts() {
    const mappedData = myProducts.products.map(meriProduct => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
        <h2>${meriProduct.title}</h2>
        <p>${meriProduct.description}</p>
                <footer>
                    <h4>$${meriProduct.price}</h4>
                    <h4>${meriProduct.discountPercentage}</h4>
                    </footer>
            </div>
        `
    }).join(" ")
...
function getSmartPhones() {
    const fetchPhones = myProducts.products.filter(meriCategory => meriCategory.category === "smartphones")
    let mappedData = fetchPhones.map((meriProduct) => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
...
function getLaptops() {
    const fetchLaptops = myProducts.products.filter(meriCategory => meriCategory.category === "laptops")
    let mappedData = fetchLaptops.map((meriProduct) => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
...
function getFragrances() {
    const fetchPerfumes = myProducts.products.filter(meriCategory => meriCategory.category === "fragrances")
    let mappedData = fetchPerfumes.map((meriProduct) => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
...
function getGroceries() {
    const fetchGroceries = myProducts.products.filter(meriCategory => meriCategory.category === "groceries")
    let mappedData = fetchGroceries.map((meriProduct) => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
...
function getDecorations() {
    const fetchDecorations = myProducts.products.filter(meriCategory => meriCategory.category === "home-decoration")
    let mappedData = fetchDecorations.map((meriProduct) => {
        return `
        <div class="product">
        <img src=${meriProduct.thumbnail} alt="" />
        <h3>${meriProduct.category}</h3>
...
const inputElement = document.querySelector(".searchFeild input");

inputElement.addEventListener("input", function () {
    const inputValue = inputElement.value.toLowerCase();
    const searchVal = myProducts.products.filter((item) => {
        return item.title.toLowerCase().startsWith(inputValue);
    })
    displayedProduct(searchVal);
});


function displayedProduct(searchVal) {
    products.innerHTML = "";
